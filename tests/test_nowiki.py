...
class NowikiTests(ParserTestCase):
    ...
    def test_nested_nowiki(self):
        ...
        result = "[paragraphs:[paragraph:[nowiki:'some [[text]] <nowiki>that should '  internal_link:[page_name:'Template:not']  raw_text:' be changed'  LT:'<'  allowed_char:'/'  raw_text:'nowiki'  GT:'>']]]"
        self.parsed_equal_string(source, result, None)
